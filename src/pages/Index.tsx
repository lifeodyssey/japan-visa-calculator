...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-japan-white via-blue-50 to-purple-50 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-4xl bg-white/90 backdrop-blur-md rounded-2xl shadow-2xl p-8 transform transition-all duration-300 hover:shadow-3xl border border-white/20">
        <header className="w-full mb-8 text-center relative">
          <div className="absolute right-0 top-0 flex gap-2">
            <GitHubStats />
            <LanguageSwitch />
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4 font-japanese text-japan-black mt-12 bg-gradient-to-r from-japan-red via-japan-blue to-japan-red bg-clip-text text-transparent animate-gradient">
            {t('title')}
          </h1>
        ...
        <footer className="w-full text-center text-sm text-gray-500 mt-8 border-t border-gray-200 pt-4">
