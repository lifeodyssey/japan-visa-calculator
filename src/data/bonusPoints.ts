// Japan Highly Skilled Professional Visa Bonus Points System
// 15 Official Bonus Point Categories (ボーナス①-⑮)
...
export const allBonusPoints: BonusPointItem[] = [
  bonus01_research,
  bonus02_position, 
...
export const getBonusPointsForCategory = (visaCategory: 'academic' | 'specialized' | 'management') => {
  return allBonusPoints.filter(bonus =>
